...
namespace Services
{
    public class BaseService
    {
        ...
        protected readonly IConfiguration _tutorSubscriptionConfiguration = new ConfigurationBuilder().AddJsonFile(Path.Combine(Directory.GetCurrentDirectory(), "Properties", "tutorSubscription.json")).Build();
        protected readonly IConfiguration _studentSubscriptionConfiguration = new ConfigurationBuilder().AddJsonFile(Path.Combine(Directory.GetCurrentDirectory(), "Properties", "studentSubscription.json")).Build();
